...
def hyperparams_convert_back(hyperparams):
    ...
    batch_size_inv = {8: 1, 16: 2, 32: 3, 64: 4}
...
if __name__ == "__main__":
    ...
    for seed in range(0, 1):
        ...
        accs, prediction_flips = distill(converted_sol, eval=False, surrogate=False, model_name='mo_model.bin', seed=1)
        accs, prediction_flips = distill(converted_sol, eval=True, surrogate=False, model_name='mo_model.bin', seed=1)
        ...
        #results_file = "mo_avatar_results.csv"
        ...
        #        row_data = [
        #            seed,
        #            "NSGA3",  # Ensure NSGA3 is saved as a string
        #            res.F[index, 0],
        #            -res.F[index, 1],
        #            res.F[index, 2],
        #            res.F[index, 3]
